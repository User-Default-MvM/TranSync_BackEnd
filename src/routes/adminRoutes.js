...
router.get("/users", allowRoles("SUPERADMIN"), adminController.getUsers);

// GET /api/admin/conductores-gestores - Listar conductores y gestores
router.get("/conductores-gestores", allowRoles("SUPERADMIN"), adminController.getConductoresYGestionadores);
...
router.get("/stats", allowRoles("SUPERADMIN"), adminController.getStats);

// GET /api/admin/stats/users - Estadísticas de usuarios
router.get("/stats/users", allowRoles("SUPERADMIN"), adminController.getUserStats);

// GET /api/admin/stats/system - Estadísticas de sistema
router.get("/stats/system", allowRoles("SUPERADMIN"), adminController.getSystemStats);
...
router.get("/access-check", allowRoles("SUPERADMIN"), adminController.checkAdminAccess);
